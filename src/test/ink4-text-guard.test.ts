...
const ALLOWED_INK4_TEXT_CONTEXT_SITES = [
  ...
  'features/transactions/components/DragDropOverlay.tsx:91', // drag_indicator <Icon>
  'features/transactions/components/TransactionRow.tsx:112', // drag_indicator <Icon> (pointerEvents:none)
